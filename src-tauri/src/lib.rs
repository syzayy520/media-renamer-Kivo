...
use commands::{
    ...
    get_tmdb_gate_status, probe_media_info_fields, rollback_rename_task, safe_execute_rename,
    scrape_to_local_metadata, search_tmdb_candidates, set_confidence_threshold, set_template,
...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            set_tmdb_api_key,
            clear_tmdb_api_key,
            get_tmdb_config_status,
            get_tmdb_gate_status,
            set_tmdb_gate_enabled,
            test_tmdb_connection,
            get_task,
            get_all_tasks,
            get_audit_logs,
            search_tmdb_candidates,
            apply_tmdb_candidate,
            get_safety_summary,
            safe_execute_rename,
